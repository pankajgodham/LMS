...
import { createCource, createLecture, editCource, editLecture, getCourceById, getCourceLecture, getCreatorCources, getLectureById, publishedCource, removeLecture, togglePublishCource } from '../controller/cource.controller.js';
import upload from '../utils/multer.js'
const router=express.Router();
router.route("/").post(isAuthenticated,createCource)
router.route("/published-cources").get(isAuthenticated,publishedCource) 
