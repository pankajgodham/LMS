...
const HeroSection = () => {
  return (
    ...
    <h1 className='text-white text-4xl font-bold mb-4'>Find the best Cource for you</h1>
...
Discover,Learn and Upskill with our wide range of cources
    ...
    <form action="" className='flex items-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden max-w-xl mx-auto mb-6'>
        ...
        className='flex-grow border-none focus-visible:ring-0 px-6 py-3 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500'></Input>
